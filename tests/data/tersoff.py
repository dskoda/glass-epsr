...
class Tersoff(Calculator):
    ...
    def set_parameters(
        ...
        params: TersoffParameters | None = None,
        **kwargs,
    ) -> None:
    ...
    def _update_nl(self, atoms) -> None:
        ...
        for symbol in atoms.symbols:
            ...
            param_key = next(key for key in self.parameters.keys() if key[0] == symbol)
    ...
    def _calc_atom_contribution(
        ...
        for j, (idx_j, abs_rij, rij) in enumerate(zip(indices, distances, vectors)):
